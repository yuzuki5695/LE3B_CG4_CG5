...
enum ImGuiFocusedFlags_
{
    ...
    ImGuiFocusedFlags_NoPopupHierarchy              = 1 << 3,   // Do not consider popup hierarchy (do not treat popup circle_ as parent of popup) (when used with _ChildWindows or _RootWindow)
...
enum ImGuiHoveredFlags_
{
    ...
    ImGuiHoveredFlags_NoPopupHierarchy              = 1 << 3,   // IsWindowHovered() only: Do not consider popup hierarchy (do not treat popup circle_ as parent of popup) (when used with _ChildWindows or _RootWindow)
